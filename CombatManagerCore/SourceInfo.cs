...
namespace CombatManager
{
    ...
    public sealed class SourceInfo
    {
        ...
        static SourceInfo()
        {
            ...
            AddToMap("Rise of the Runelords: Burnt Offerings", SourceType.AdventuresAndModules, "AP 1", "AP1", "PAP1:RotR1");
            AddToMap("Rise of the Runelords: Fortress of the Stone Giants", SourceType.AdventuresAndModules, "AP 4", "AP4", "PAP4:RotR4");
            AddToMap("Rise of the Runelords: Hook Mountain Massacre", SourceType.AdventuresAndModules, "AP 3", "AP3", "PAP3:RotR3");
            AddToMap("Rise of the Runelords: Sins of the Saviors", SourceType.AdventuresAndModules, "AP 5", "AP5", "PAP5:RotR5");
            AddToMap("Rise of the Runelords: Spires of Xin-Shalast", SourceType.AdventuresAndModules, "AP 6", "AP6", "PAP6:RotR6");
            AddToMap("Rise of the Runelords: The Skinsaw Murders", SourceType.AdventuresAndModules, "AP 2", "AP2", "PAP2:RotR2", "Pathfinder 2: The Skinsaw Murders");
